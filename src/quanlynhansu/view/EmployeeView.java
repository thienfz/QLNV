...
public class EmployeeView extends javax.swing.JFrame {
    ...
    public EmployeeView(EmployeeDTO e) {
        initComponents();
        this.department.setEnabled(false);
        this.room.setEnabled(false);
        this.prname.setEnabled(false);
        this.role.setEnabled(false);
        this.title.setText(" " + e.getUsername());
        this.uid.setText(e.getUid() + "");
        this.username.setText(e.getUsername());
        this.password.setText(e.getPassword());
        this.fullname.setText(e.getFullname());
        this.address.setText(e.getAddress());
        this.phone.setText(e.getPhone());
        this.department.setSelectedItem(departmentDAO.getDepByID(roomDAO.getRoomByID(e.getRid()).getDepid()));
        this.department.removeAllItems();
        this.prname.removeAllItems();
        for (int i = 0; i < listPr.size(); i++) {
            prname.addItem(listPr.get(i).getPrname());
            if (listPr.get(i).getPrid() == e.getPrid()) {
                prname.setSelectedIndex(i);
            }
        }
        ...
        this.department.setSelectedItem(
                departmentDAO.getDepByID(
                        roomDAO.getRoomByID(e.getRid()).getDepid()).getDepname());
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(30, 30, 30)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(prname, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(uid)
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        int prid = this.listPr.get(this.prname.getSelectedIndex()).getPrid();
        ...
        try {
            ...
            employeeDAO.editEmployee(new EmployeeDTO(
                    Integer.valueOf(uid.getText()),
                    username,
                    password,
                    fullname,
                    address,
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new MessageView(Integer.valueOf(uid.getText())).setVisible(true);        // TODO add your handling code here:
    ...
    public javax.swing.JComboBox<String> prname;
    public javax.swing.JComboBox<String> role;
    public javax.swing.JComboBox<String> room;
